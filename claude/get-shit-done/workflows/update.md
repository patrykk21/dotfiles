...
if [ -f ./.claude/get-shit-done/VERSION ]; then
  ...
  echo "LOCAL"
elif [ -f /Users/vigenerr/.claude/get-shit-done/VERSION ]; then
  cat /Users/vigenerr/.claude/get-shit-done/VERSION
  echo "GLOBAL"
else
  echo "UNKNOWN"
fi
...
(Paths are relative to your install location: `/Users/vigenerr/.claude/` for global, `./.claude/` for local)
...
**If GLOBAL install:**
```bash
rm -f /Users/vigenerr/.claude/cache/gsd-update-check.json
```
